    ...
    return (
        <>
            ...
            <div className='d-lg-flex justify-content-center align-items-center w-75 mx-auto gap-4'>
                <div className='border rounded-5 p-5 mb-2 mb-lg-0' data-aos="zoom-in" data-aos-duration="2000" >
                ...
                <div className='border rounded-5 p-5 bg-primary text-white  mb-2 mb-lg-0' data-aos="zoom-in" data-aos-duration="2000">
                ...
                <div className='border rounded-5 p-5' data-aos="zoom-in" data-aos-duration="2000">

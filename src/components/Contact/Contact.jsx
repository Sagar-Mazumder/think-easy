...
const Contact = () => {
    return (
        <>
            <div className='mt-5' id='contact' style={ {scrollMarginTop:100}}>
                <div className='d-lg-flex justify-content-between  w-75 mx-auto gap-5'>
                    <div>
                        <div className=''>
                        ...
                        <div className='d-flex align-items-center gap-2'>
                            <h1 className='text-primary'><FontAwesomeIcon icon={faEnvelope} /></h1>
                            <div>
                                <h4>Email Us</h4>
                        ...
                        <div className='d-flex align-items-center gap-2'>
                            <h1 className='text-primary'><FontAwesomeIcon icon={faPhoneVolume} /></h1>
                            <div>
                                <h4>Call Us</h4>
                                <p>1245875687</p>
                            </div>
                        ...
                        <div className='d-flex align-items-center gap-2'>
                            <h1 className='text-primary'><FontAwesomeIcon icon={faMap} /></h1>
                            <div>
                                <h4>Visit Us</h4>
                    ...
                    <div>
                        ...
                        <div>
                            <Form>
                                ...
                                <Button className='px-5 py-3 rounded-5' variant="primary" type="submit">
                                    Submit Comment
                                </Button>
                            </Form>
                        </div>
